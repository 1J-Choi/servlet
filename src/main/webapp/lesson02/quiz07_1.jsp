...
<body>
	<%
	    ...
	    String point4 = request.getParameter("4point");
	...
	<div class="container">
		...
		<table class="table text-center">
			...
			<tbody>
				<%
					for(Map<String, Object> searchedMap: searchedList) {
				%>
				<tr>
					<td><%= searchedMap.get("menu") %></td>
					<td><%= searchedMap.get("name") %></td>
					<td><%= searchedMap.get("point") %></td>
				</tr>
				<%
					}
				%>
