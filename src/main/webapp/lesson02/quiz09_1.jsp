...
<body>
    ...
    List<Map<String, String>> searchedList = new ArrayList<>();
    
    for(Map<String, String> channel: list) {
    	if(channel.get("category").equals(request.getParameter("category"))){
    		searchedList.add(channel);
    	}
    }
	%>
	...
	<div class="container">
		...
		<div>
			<table class="table text-center">
				...
				<tbody>
					<%
					for(Map<String, String> channel : searchedList) {
					%>
					<tr>
